...
export const LightBulbIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.311V21m-3.75 0V21m-3.75 0h7.5M12 15.75a3 3 0 01-3-3V4.5a3 3 0 116 0v8.25a3 3 0 01-3 3z" />
    </Icon>
);
...
export const ChatBubbleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72 3.72a1.05 1.05 0 01-1.485 0l-3.72-3.72A1.05 1.05 0 014.5 17.25V8.511c0-.97.616-1.813 1.5-2.097l5.25-1.68a1.05 1.05 0 011.05 0l5.25 1.68z" />
    </Icon>
);
...
// FIX: Corrected incomplete path data
export const UsersGroupIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.284.002A3 3 0 017.5 15.75l-2.192 2.192a3 3 0 004.242 4.242l2.192-2.192M15 13.5a3 3 0 11-6 0 3 3 0 016 0z" />
    </Icon>
);
...
export const ChatBubbleEmptyIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
...
export const AcademicCapIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0l-2.072-1.036A48.421 48.421 0 0112 4.5c5.353 0 10.197 1.166 14.28 3.102l-2.072 1.036m-16.354 0a48.47 48.47 0 01-4.796-1.954C5.825 8.78 9.236 8.5 12 8.5s6.175.28 8.796.536a48.47 48.47 0 01-4.796 1.954m-9.006 0v5.622a52.5 52.5 0 01-1.284 9.098m15.068-9.098v5.622a52.5 52.5 0 001.284 9.098" />
    </Icon>
);
...
export const QuotationMarkIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
